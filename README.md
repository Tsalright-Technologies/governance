# tsalright-technologies Governance

This document outlines a set of policies in order to provide a level playing
field and open process for contributors to join the tsalright-technologies project.

In addition to this document, this repository contains live configuration for
the state of the tsalright-technologies GitHub organization. All configuration is
...
Individual contributors to the tsalright-technologies project can become members of
...
different facets of the tsalright-technologies project. Repositories should typically belong
...
* the [**core** team](teams/core.yml) has authority over the [RFC
  ...
  push to the the [tsalright-technologies repo][tsalright-technologies-repo].
* the [**maintainers** team](teams/maintainers.yml) has authority over the
  [tsalright-technologies repo][tsalright-technologies-repo] and submits RFCs to develop a roadmap that
  aligns with tsalright-technologies's core design principles.
...
* the **maintainers** team then guides the planning and implementation of the
  proposal through pull requests to the tsalright-technologies repo.
...
[rfcs-repo]: https://github.com/tsalright-technologies/rfcs
[tsalright-technologies-repo]: https://github.com/tsalright-technologies/tsalright-technologies
...
Each contributor will be granted membership of the tsalright-technologies GitHub
...
To apply these changes you must be an Owner of the tsalright-technologies GitHub
organization.
...
[member-privileges]: https://github.com/organizations/tsalright-technologies/settings/member_privileges
